...
public interface AssociatesApi {
    ...
    @Operation(summary = "Find a associate", description = "Return a associate according to the ID", tags={ "Associates" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "OK", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Associate.class))),
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "206", description = "Partial Content", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = Associate.class)))),
    ...
    @RequestMapping(value = "/associates",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<Associate>> findAssociates(@Parameter(in = ParameterIn.QUERY, description = "Product name" ,schema=@Schema()) @Valid @RequestParam(value = "name", required = false) String name);


    @Operation(summary = "Insert a Associate", description = "Insert a Associate", tags={ "Associates" })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Void> insertAssociate(@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema()) @Valid @RequestBody Associate body);


    @Operation(summary = "Remove a associate", description = "Remove a associate", tags={ "Associates" })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Void> removeAssociate(@Parameter(in = ParameterIn.PATH, description = "Unique identifier", required=true, schema=@Schema()) @PathVariable("id") String id);
