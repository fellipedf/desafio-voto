...
public interface AssociatesApi {
    ...
    @RequestMapping(value = "/associates",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Associate> findAssociates(@Parameter(in = ParameterIn.QUERY, description = "Product name" ,schema=@Schema()) @Valid @RequestParam(value = "name", required = false) String name);
