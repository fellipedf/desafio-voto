...
public interface VotingSessionApi {
    ...
    ResponseEntity<MeetingAgendaItems> findVotingSession(@Parameter(in = ParameterIn.QUERY, description = "Scheduler description" ,schema=@Schema()) @Valid @RequestParam(value = "description", required = false) String description);
